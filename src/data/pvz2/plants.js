...
export const plants = [
  ...
  // === 功夫世界 (Kongfu World) ===
  {
    ...
    category: "defensive",
    world: "kongfu_world",
    unlockLevel: "功夫世界 - 第6天",
    plantFoodEffect: "在随机位置创建一个分身。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "萝卜不会被气功僵尸拉动或被虫洞吸入，还能保护身后的植物。",
    image: "/images/pvz2/plants/resistant_radish.png",
  },
  {
    id: "fire_gourd",
    source: "china",
    ...
    category: "explosive",
    world: "kongfu_world",
    unlockLevel: "功夫世界 - 第3天",
    plantFoodEffect: "向前方所有格子喷火，造成1500点伤害。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "火葫芦喷射火焰造成中等伤害，但攻击距离短，点击后会进入休眠。",
  ...
  },
  {
    ...
    world: "kongfu_world",
    unlockLevel: "390颗星星",
    plantFoodEffect: "使周围所有植物暂时无敌。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "仙桃治愈周围的植物。",
    image: "/images/pvz2/plants/heavenly_peach.png",
  },
  {
    id: "bamboo_shoot",
    source: "china",
    ...
    category: "shooter",
    world: "kongfu_world",
    unlockLevel: "收集10个竹笋拼图碎片",
    plantFoodEffect: "攻击每行最后一只僵尸及其附近僵尸，将弱僵尸击飞。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "竹笋攻击前方最多四格的僵尸。",
    image: "/images/pvz2/plants/bamboo_shoot.png",
  },
  // === 天空之城 (Sky City) ===
  {
    id: "loquat",
    ...
    category: "support",
    world: "sky_city",
    unlockLevel: "天空之城 - 第6天",
    plantFoodEffect: "无植物食物效果。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "枇杷制造旋涡，将3x3范围内的僵尸拉到一起。",
    image: "/images/pvz2/plants/loquat.png",
  },
  {
    id: "asparagus",
    source: "china",
    ...
    world: "sky_city",
    unlockLevel: "85颗星星",
    plantFoodEffect: "向范围内所有格子发射高伤害弹幕。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "芦笋向前方和两行攻击左右两侧的僵尸。",
    image: "/images/pvz2/plants/asparagus.png",
  },
  {
    id: "saucer",
    source: "china",
    ...
    category: "support",
    world: "sky_city",
    unlockLevel: "收集10个飞碟花拼图碎片",
    plantFoodEffect: "使屏幕上所有僵尸眩晕。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "飞碟花发射光线使僵尸停止移动。",
    image: "/images/pvz2/plants/saucer.png",
  },
  {
    id: "horsebean",
    source: "china",
    ...
    category: "shooter",
    world: "sky_city",
    unlockLevel: "收集10个马豆射手拼图碎片",
    plantFoodEffect: "召唤6个马豆持续一分钟攻击全场，冷却时间缩短。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "马豆射手攻击周围僵尸。",
    image: "/images/pvz2/plants/horsebean.png",
  },
  {
    id: "groundcherry",
    source: "china",
    ...
    category: "support",
    world: "sky_city",
    unlockLevel: "天空之城 - 第18天",
    plantFoodEffect: "显示屏幕上所有隐形僵尸。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "酸浆使隐形僵尸变为可见状态。",
    image: "/images/pvz2/plants/groundcherry.png",
  },
  {
    id: "anthurium",
    source: "china",
    ...
    category: "shooter",
    world: "sky_city",
    unlockLevel: "天空之城 - 第8天",
    plantFoodEffect: "移除所有植物的充能，并向僵尸发射闪电。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "红掌花吸收雷电，移除3x3范围内植物的充能，并攻击前方僵尸。",
    image: "/images/pvz2/plants/anthurium.png",
  },
  {
    id: "pineapple",
    source: "china",
    ...
    category: "defensive",
    world: "sky_city",
    unlockLevel: "收集10个菠萝拼图碎片",
    plantFoodEffect: "旋转收集3x1范围内所有僵尸子弹并反弹回去。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "菠萝通过旋转反弹来阻止僵尸和子弹。",
    image: "/images/pvz2/plants/pineapple.png",
  },
  // === 蒸汽时代 (Steam Age) ===
  {
    id: "flat_shroom",
    ...
    category: "support",
    world: "steam_age",
    unlockLevel: "蒸汽时代 - 第1天",
    plantFoodEffect: "在任意开放下水道上投放1-2个额外的平菇。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "平菇只能种在没有井盖的下水道上，暂时阻止有毒蒸汽释放。",
    image: "/images/pvz2/plants/flat_shroom.png",
  },
  {
    id: "lotus_shooter",
    source: "china",
    name: "莲藕射手",
    nameEn: "Lotus Shooter",
    sunCost: 200,
    recharge: 5,
    damage: 40,
    health: 300,
    ...
    category: "shooter",
    world: "steam_age",
    unlockLevel: "蒸汽时代 - 第6天",
    plantFoodEffect: "发射大量水滴击退僵尸，最后发射一个造成800伤害的大泡泡。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "莲藕射手可以吸收有毒蒸汽造成额外伤害。",
    image: "/images/pvz2/plants/lotus_shooter.png",
  },
  {
    id: "maypop_mechanic",
    source: "china",
    name: "西番莲机械师",
    nameEn: "Maypop Mechanic",
    sunCost: 125,
    recharge: 5,
    damage: 20,
    health: 300,
    ...
    category: "shooter",
    world: "steam_age",
    unlockLevel: "收集10个西番莲机械师拼图碎片",
    plantFoodEffect: "制造一个巨大齿轮扔向最近的僵尸，持续时间更长，造成3x3范围伤害。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "西番莲机械师向本行及上下行最近的僵尸发射齿轮。",
    image: "/images/pvz2/plants/maypop_mechanic.png",
  },
  {
    id: "fanilla",
    source: "china",
    ...
    category: "support",
    world: "steam_age",
    unlockLevel: "蒸汽时代 - 第2天",
    plantFoodEffect: "制造龙卷风沿对角线前进，遇到边界反弹，可吹飞最多5只僵尸。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "风扇花可以吹走绅士僵尸的雨伞。",
    image: "/images/pvz2/plants/fanilla.png",
  },
  {
    id: "mulberry_blaster",
    source: "china",
    name: "桑葚爆破手",
    nameEn: "Mulberry Blaster",
    sunCost: 150,
    recharge: 20,
    damage: 200,
    health: 300,
    ...
    category: "explosive",
    world: "steam_age",
    unlockLevel: "收集10个桑葚爆破手拼图碎片",
    plantFoodEffect: "向随机僵尸发射7颗桑葚。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "桑葚爆破手每5秒发射一颗桑葚，造成1x1范围200点伤害。",
    image: "/images/pvz2/plants/mulberry_blaster.png",
  },
  // === 复兴时代 (Renaissance Age) ===
  {
    id: "rose_swordfighter",
    source: "china",
    name: "玫瑰剑客",
    nameEn: "Rose Swordfighter",
    sunCost: 225,
    recharge: 20,
    damage: 50,
    health: 300,
    ...
    unlockLevel: "收集10个玫瑰剑客拼图碎片",
    plantFoodEffect: "刺击3x3范围内的僵尸。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "玫瑰剑客攻击靠近的僵尸，对低生命值僵尸发动强力攻击。",
    image: "/images/pvz2/plants/rose_swordfighter.png",
  },
  {
    id: "bearberry_mortar",
    source: "china",
    name: "熊果迫击炮",
    nameEn: "Bearberry Mortar",
    sunCost: 150,
    recharge: 20,
    damage: 80,
    health: 300,
    ...
    category: "explosive",
    world: "renaissance_age",
    unlockLevel: "收集10个熊果迫击炮拼图碎片",
    plantFoodEffect: "发射三颗更大的熊果：一行一个，对角各一个，清除大部分僵尸。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "熊果迫击炮发射滚动的熊果壳攻击一排僵尸。",
    image: "/images/pvz2/plants/bearberry_mortar.png",
  },
  {
    id: "wax_gourd_guard",
    source: "china",
    name: "冬瓜卫士",
    nameEn: "Wax Gourd Guard",
    sunCost: 125,
    recharge: 20,
    damage: null,
    health: 3000,
    ...
    category: "defensive",
    world: "renaissance_age",
    unlockLevel: "复兴时代 - 第1天",
    plantFoodEffect: "每次弹跳3次。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "冬瓜卫士在僵尸靠近时弹跳击退僵尸，还能激活百合花地板瓷砖。",
    image: "/images/pvz2/plants/wax_gourd_guard.png",
  },
  {
    id: "oily_olive",
    source: "china",
    ...
    category: "support",
    world: "renaissance_age",
    unlockLevel: "复兴时代 - 第14天",
    plantFoodEffect: "无植物食物效果。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "油橄榄可以使芭蕾僵尸滑倒，油可以被火焰植物点燃。",
    image: "/images/pvz2/plants/oily_olive.png",
  },
  // === 平安时代 (Heian Age) ===
  {
    id: "dripping_diphylleia",
    source: "china",
    name: "滴水观音",
    nameEn: "Dripping Diphylleia",
    sunCost: 50,
    recharge: 5,
    damage: null,
    health: 300,
    ...
    category: "support",
    world: "heian_age",
    unlockLevel: "平安时代 - 第2天",
    plantFoodEffect: "在5x5范围内泼水，恢复花瓣并增加泼水次数。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "滴水观音可以熄灭被烟花僵尸点燃的植物，并减速周围僵尸。",
    image: "/images/pvz2/plants/dripping_diphylleia.png",
  },
  {
    id: "dendrobium_windbreak",
    source: "china",
    name: "铁皮石斛",
    nameEn: "Dendrobium Windbreak",
    sunCost: 100,
    recharge: 20,
    damage: null,
    health: 1500,
    ...
    category: "defensive",
    world: "heian_age",
    unlockLevel: "平安时代 - 第11天",
    plantFoodEffect: "恢复生命值和所有叶片，用顶部叶片作螺旋桨攻击并击退前方僵尸。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "铁皮石斛可以连接在一起抵御强风。",
    image: "/images/pvz2/plants/dendrobium_windbreak.png",
  },
  {
    id: "stephania",
    source: "china",
    ...
    category: "shooter",
    world: "heian_age",
    unlockLevel: "平安时代 - 第5天",
    plantFoodEffect: "向前方发射6片叶子，击退僵尸并分裂造成额外伤害。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "千金藤可以抵御忍者小鬼的河豚攻击，投掷的盾牌会碎裂。",
    image: "/images/pvz2/plants/stephania.png",
  },
  {
    id: "tupistra_stalker",
    source: "china",
    name: "蜘蛛抱蛋",
    nameEn: "Tupistra Stalker",
    sunCost: 200,
    recharge: 15,
    damage: 60,
    health: 300,
    ...
    category: "shooter",
    world: "heian_age",
    unlockLevel: "收集10个蜘蛛抱蛋拼图碎片",
    plantFoodEffect: "从地面跳出，在3x3范围内投掷多个叶刃，对区域内僵尸造成大量伤害。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "蜘蛛抱蛋从地下冒出伤害附近的僵尸。",
    image: "/images/pvz2/plants/tupistra_stalker.png",
  },
  {
    id: "chef_cypripedium",
    source: "china",
    name: "大花杓兰",
    nameEn: "Chef Cypripedium",
    sunCost: 150,
    recharge: 5,
    damage: 40,
    health: 300,
    ...
    category: "support",
    world: "heian_age",
    unlockLevel: "收集10个大花杓兰拼图碎片",
    plantFoodEffect: "瞄准5只最近的僵尸投掷5团大汤球，造成3x3范围伤害和气味效果。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "大花杓兰的汤会使僵尸改变路线。",
    image: "/images/pvz2/plants/chef_cypripedium.png",
  },
  {
    id: "boophone_geigi",
    source: "china",
    name: "布冯花",
    nameEn: "Boophone Geigi",
    sunCost: 175,
    recharge: 15,
    damage: 50,
    health: 300,
    ...
    category: "shooter",
    world: "heian_age",
    unlockLevel: "收集10个布冯花拼图碎片",
    plantFoodEffect: "沿行投掷一把火焰扇，击中第一只僵尸后分裂成两半从上下相邻行返回。",
    upgradeable: false,
    maxUpgradeLevel: null,
    upgradeEffect: null,
    description: "布冯花的回旋扇可以伤害攻击范围内的僵尸。",
    image: "/images/pvz2/plants/boophone_geigi.png",
  }
]
